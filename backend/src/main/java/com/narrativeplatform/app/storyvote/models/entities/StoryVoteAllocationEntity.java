...
@NoArgsConstructor
@Entity
@Table(name = "story_vote_allocations", uniqueConstraints = @UniqueConstraint(columnNames = {"chronicle_id", "membership_id", "vote_date"}))
public class StoryVoteAllocationEntity {
    @Id
    ...
    public StoryVoteAllocationEntity(
            final PartyEntity party,
            final ChronicleEntity chronicle,
            final PartyMemberEntity membership,
            final LocalDate voteDate,
            final short units
    ) {
        this.party = party;
